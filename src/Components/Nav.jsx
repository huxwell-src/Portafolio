...
export function NavBar() {
  ...
  const navList = (
    ...
    <ul className="mb-4 mt-2 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
        ...
        <a href="#contact" className="flex items-center text-dark-blue hover:text-light-blue font-semibold duration-150 ease-in-out dark:text-light-gray dark:hover:text-hyper-light-blue">
            {t("nav.contacts")}
        </a>
  ...
  return (
    <div className="fixed w-screen bg-white dark:bg-hyper-dark-  z-50">
      <Navbar className="mx-auto md:w-10/12 py-2 px-4 lg:px-8 lg:py-4 shadow-none dark:bg-hyper-dark-blue border-none">
        ...
        <MobileNav open={openNav} >
          ...
          <div className="flex justify-between">
            <button variant="gradient" size="sm"  className="w-full rounded-full flex items-center" onClick={() => i18n.changeLanguage("es")}>
              <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 512 512" className='mx-2 rounded-full '>
                  <mask id="a"><circle cx="256" cy="256" r="256" fill="#fff"/></mask>
                  <g mask="url(#a)"><path fill="#d80027" d="m0 256 254.5-51.3L512 256v256H0z"/>
                  <path fill="#0052b4" d="M0 0h256l52.7 132.8L256 256H0z"/>
                  <path fill="#eee" d="M256 0h256v256H256zM152.4 89l16.6 51h53.6l-43.4 31.6 16.6 51-43.4-31.5-43.4 31.5 16.6-51L82.2 140h53.6z"/></g>
              </svg> 
              <span className="text-light-blue font-semibold">Español</span>
            </button>
            <button variant="gradient" size="sm"  className="w-full rounded-full flex items-center" onClick={() => i18n.changeLanguage("en")}>
              <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 512 512" className='mx-2 rounded-full'>
                <mask id="a"><circle cx="256" cy="256" r="256" fill="#fff"/>
                </mask><g mask="url(#a)">
                <path fill="#eee" d="M256 0h256v64l-32 32 32 32v64l-32 32 32 32v64l-32 32 32 32v64l-256 32L0 448v-64l32-32-32-32v-64z"/>
              ...
              <span  className="text-light-blue font-semibold">Ingles</span>
            </button>
          </div>
        </MobileNav>
